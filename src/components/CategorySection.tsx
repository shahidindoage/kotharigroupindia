                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-3 mb-3">
                      <div className={`p-3 rounded-xl ${isSelected ? 'bg-[#1575B3] text-white' : 'bg-[#F5FAFF] text-[#1575B3]'}`}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {filteredProducts.map((product) => {
                  ...
                  return (
                    <div
                      key={product.id}
                      className="bg-[#FFFFFF] rounded-2xl border border-[#DCEAF5] p-5 hover:shadow-xl transition-all flex flex-col justify-between group text-left"
                    >
                      <div className="space-y-3">
                        <div className="relative aspect-[16/10] bg-[#F5FAFF] rounded-xl overflow-hidden border border-[#DCEAF5]">
                          <img
                            src={product.image}
                            alt={product.name}
                        ...
                        {/* <div className="bg-[#F5FAFF] p-3 rounded-xl border border-[#DCEAF5] space-y-1 text-xs font-bold text-[#111111]">
        ...
        {activeMainCategory === 'Projects' && (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {projectsList.map((proj, idx) => (
              <div
                key={idx}
                className="bg-[#F5FAFF] rounded-2xl border border-[#DCEAF5] p-6 hover:shadow-xl transition-all space-y-4 text-left flex flex-col justify-between"
              >
                <div className="space-y-3">
                  <div className="aspect-[16/10] rounded-xl overflow-hidden border border-[#DCEAF5] bg-white">
                    <img
                      src={proj.image}
                      alt={proj.title}
                      referrerPolicy="no-referrer"
                  ...
                  {/* <div className="bg-white p-3 rounded-xl border border-[#DCEAF5] text-xs font-extrabold text-[#1575B3]">
                    Impact: {proj.impact}
                  </div> */}
                </div>
