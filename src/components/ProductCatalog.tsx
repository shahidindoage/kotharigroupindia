...
import { ProductItem, PipeCategory } from '../types';
import { 
  Search, 
  Filter, 
  Check, 
  ...
  return (
    <section id="products" className="py-16 bg-[#F5FAFF] border-b border-[#DCEAF5]">
      <div className="max-w-7xl mx-auto px-4 sm:px-8 space-y-10">
        ...
        <div className="bg-[#FFFFFF] p-4 rounded-2xl border border-[#DCEAF5] shadow-xs space-y-4">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 border-b border-[#DCEAF5] pb-4">
            ...
            <div className="relative w-full md:w-80">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 bg-[#F5FAFF] border border-[#DCEAF5] rounded-xl text-xs font-semibold text-[#111111] placeholder-[#5F6B7A] focus:outline-none focus:ring-2 focus:ring-[#1575B3]/30"
              />
            </div>
            ...
            <div className="flex items-center gap-3 w-full md:w-auto justify-end">
              ...
              <select
                ...
                className="bg-[#F5FAFF] border border-[#DCEAF5] rounded-xl px-3 py-2 text-xs font-semibold text-[#111111] focus:outline-none focus:ring-2 focus:ring-[#1575B3]/30"
              >
              ...
              {specList.length > 0 && (
                <button
                  ...
                  className="bg-[#1575B3] text-white text-xs font-bold px-3 py-2 rounded-xl flex items-center gap-1.5 shadow-sm hover:bg-[#0E588A] transition"
                >
        ...
        {filteredProducts.length === 0 ? (
          <div className="bg-[#FFFFFF] p-12 rounded-2xl border border-[#DCEAF5] text-center space-y-3">
            ...
            <button
              ...
              className="mt-2 bg-[#1575B3] text-white text-xs font-bold px-4 py-2 rounded-xl hover:bg-[#0E588A]"
            >
              Reset All Filters
            </button>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredProducts.map((product) => {
              ...
              return (
                <div
                  key={product.id}
                  className="bg-[#FFFFFF] rounded-2xl border border-[#DCEAF5] shadow-xs hover:border-[#1575B3]/60 hover:shadow-lg transition-all duration-300 flex flex-col justify-between overflow-hidden group"
                >
                  {/* Card Header & Image */}
                  <div>
                    ...
                    <div className="p-5 space-y-4">
                      ...
                      <div className="grid grid-cols-2 gap-2 bg-[#F5FAFF] p-3 rounded-xl border border-[#DCEAF5] text-[11px]">
                  ...
                  <div className="p-5 pt-0 grid grid-cols-2 gap-2">
                    <button
                      ...
                      className="w-full bg-[#F5FAFF] hover:bg-[#DCEAF5]/50 text-[#1575B3] border border-[#DCEAF5] py-2.5 rounded-xl font-bold text-xs flex items-center justify-center gap-1.5 transition"
                    >
